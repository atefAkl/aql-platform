        ...
        <div className="min-h-screen bg-slate-950 text-slate-100 flex items-center justify-center p-4 font-sans" dir="rtl">
            <div className="w-full max-w-md bg-slate-900 border border-slate-800 rounded-2xl p-8 shadow-2xl space-y-6">
                ...
                <div className="text-center space-y-2">
                    ...
                    <h1 className="text-xl font-bold text-slate-100">تسجيل الدخول للمنصة</h1>
                    <p className="text-xs text-slate-400">Stateful Cookie/Session Authentication (ADR-003)</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    >
                        ...
                        {processing ? 'جاري التحقق...' : 'دخول الحساب'}
                    </button>
                </form>
